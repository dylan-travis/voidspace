...
const NavBar = () => {
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-black">
      ...
      <div className="flex flex-wrap items-center justify-between md:mx-auto p-4 dark:bg-black">
        <div className="flex md:order-2 dark:bg-black">
          {/* Login/Logout/Profile buttons */}
          {status === 'authenticated' && (
            <>
          <Link href="/profile"><AccountBoxIcon href="/profile" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent justify-end dark:bg-black"></AccountBoxIcon></Link>
          <Link href="/cart"><ShoppingCartIcon type="link" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent justify-end dark:bg-black" title="Cart">Cart</ShoppingCartIcon></Link>
          </>)}
          {status === 'unauthenticated' && (
            <LoginIcon
              type="button"
              className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent justify-end dark:bg-black"
              title="Login"
              onClick={() => signIn()}
            >
              Login
        ...
        <div className="hidden w-full md:block md:w-auto dark:bg-black" id="navbar-default">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-black md:dark:bg-gray-900">
            <li>
              <Link href="/" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent text-base dark:bg-black" aria-current="page">Home</Link>
            </li>
            <>
              <li>
                <Link href="/booking" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent text-base dark:bg-black">Booking</Link>
              </li>
            </>
            <li>
